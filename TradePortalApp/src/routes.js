...
const MISCharts = React.lazy(() => import('./views/charts/MISCharts'));
const Dashboard = React.lazy(() => import('./views/dashboard/Dashboard'));
const CustomerSearch = React.lazy(() => import('./views/dashboard/CustomerSearch'));
...
const routes = [
  ...
  { path: '/mischarts', name: 'MISCharts', component: MISCharts },
